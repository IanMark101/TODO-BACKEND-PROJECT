...
import { createEmailVerificationToken, createRefreshTokenInDb, validateTokenRecord, } from "../utils/token";
...
export class AuthService {
    async signup(input) {
        ...
        const user = await authRepository.createUser(input.email, hashedPassword, input.name);
